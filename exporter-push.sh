...
PORT=9101
IMAGE_ORIG="swr.eu-de.otc.t-systems.com/container/nginx:latest"
IMAGE_NEW="swr.eu-de.otc.t-systems.com/container/swr-performance-test"
...
while true; do
    ...
    mkdir -p /shared
    echo "$IMAGE_TAG" > /shared/image_tag.txt
